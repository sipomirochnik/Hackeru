...
import hysb.com.example.serjofactory.security.Chat.ChatListAdapter;
...
//        DatabaseReference mUserNameDb = FirebaseDatabase.getInstance().getReference().child("user").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
